...
public class QuizLibrary {
	...
	//private String Qst, Qleft, Qright, Answer;
	...
	/**
	public void setQst() {  Qst = qstList[qtimes]; }
	public void setQleft() { Qleft = qleftList[qtimes]; }
	public void setQright() { Qright = qrightList[qtimes]; }
	public void setAnswer() { Answer = answerList[qtimes]; }
	**/
	
	public String getQst(int qtimes) {  return qstList[qtimes]; }
	public String getQleft(int qtimes) { return qleftList[qtimes]; }
	public String getQright(int qtimes) { return qrightList[qtimes]; }
	public String getAnswer(int qtimes) { return answerList[qtimes]; }
	public int getQtimes(int qtimes) { return qtimes; }
